...
import com.assignment.app.data.entity.mapper.data.FakeLocalAPI;
...
public class CountryEntityJsonMapperTest {
    ...
    public void givenTransformCollectionCountryEntityCorrectly() {
        ...
        final String FAKE_JSON_RESPONSE_COUNTRY_COLLECTION =
                FakeLocalAPI.getJsonResponseCountryCollection();
    ...
    @Test
    public void givenTransformCountryEntityCorrectly() {

        final String FAKE_JSON_RESPONSE_COUNTRY = FakeLocalAPI.getJsonResponseCountry();
        CountryEntity countryEntity = countryEntityJsonMapper.transformCountryEntity(FAKE_JSON_RESPONSE_COUNTRY);
